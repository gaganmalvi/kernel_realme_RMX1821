...
CONFIG=oppo6771_18601_defconfig
...
# Clone AnyKernel3
git clone https://github.com/gaganmalvi/AnyKernel3_rmx1821

#Download Clang
if [ ! -d clang ]; then
    wget https://android.googlesource.com/platform/prebuilts/clang/host/linux-x86/+archive/refs/tags/android-9.0.0_r45/clang-4691093.tar.gz
